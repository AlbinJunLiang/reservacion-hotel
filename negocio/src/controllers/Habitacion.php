...
class Habitacion extends ServicioCURL
{
    private const URL = '/habitacion';
    ...
    public function readRoomAvaible(Request $request, Response $response, $args)
    {

        $url = $this::URL . '/searchroom';
    ...
    public function liberar(Request $request, Response $response, $args)
    {
        $datos = $request->getBody();

        $respA = $this->ejecutarCURL($this::URL.'/release', 'PATCH', $datos);
